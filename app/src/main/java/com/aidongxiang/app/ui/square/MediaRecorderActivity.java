 ...
 * 视频录制
 */
@ContentView(com.mabeijianxi.smallvideorecord2.R.layout.activity_media_recorder)
public class MediaRecorderActivity extends BaseKtActivity implements
...
//    public final static String OVER_ACTIVITY_NAME = "over_activity_name";
     ...
     * @param context
     */
    public static void goSmallVideoRecorder(Activity context, MediaRecorderConfig mediaRecorderConfig, int requestCode) {
        context.startActivityForResult(new Intent(context, MediaRecorderActivity.class).putExtra(MEDIA_RECORDER_CONFIG_KEY, mediaRecorderConfig), requestCode);
    }
...
//        setContentView(com.mabeijianxi.smallvideorecord2.R.layout.activity_media_recorder);
        // ~~~ 绑定控件
        mSurfaceView = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_preview);
        title_layout = findViewById(com.mabeijianxi.smallvideorecord2.R.id.title_layout);
        StatusBarUtil.addStatusBarView(title_layout, com.mabeijianxi.smallvideorecord2.R.color.color_381902);
        mCameraSwitch = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_camera_switcher);
        mTitleNext = findViewById(com.mabeijianxi.smallvideorecord2.R.id.title_next);
        mProgressView = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_progress);
        mRecordDelete = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_delete);
        mRecordController = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_controller);
        mBottomLayout = findViewById(com.mabeijianxi.smallvideorecord2.R.id.bottom_layout);
        mRecordLed = findViewById(com.mabeijianxi.smallvideorecord2.R.id.record_camera_led);
        ...
        findViewById(com.mabeijianxi.smallvideorecord2.R.id.title_back).setOnClickListener(this);
//        mRecordDelete.setOnClickListener(this);
    ...
    private void initSurfaceView() {
        if (NEED_FULL_SCREEN) {
            ...
            title_layout.setBackgroundColor(getResources().getColor(com.mabeijianxi.smallvideorecord2.R.color.full_title_color));
            FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mSurfaceView
                    .getLayoutParams();
            lp.setMargins(0,0,0,0);
            mSurfaceView.setLayoutParams(lp);
            mProgressView.setBackgroundColor(getResources().getColor(com.mabeijianxi.smallvideorecord2.R.color.full_progress_color));
        } else {
            final int w = DeviceUtils.getScreenWidth(this);
            LogUtil.e("w:"+w+"             SMALL_VIDEO_HEIGHT:"+MediaRecorderBase.SMALL_VIDEO_HEIGHT+"            :"+MediaRecorderBase.SMALL_VIDEO_WIDTH);
            int topMargin = (int) (w / (MediaRecorderBase.SMALL_VIDEO_HEIGHT / (MediaRecorderBase.SMALL_VIDEO_WIDTH * 1.0f)));
            LogUtil.e("topMargin:"+topMargin);
            ((RelativeLayout.LayoutParams) mBottomLayout.getLayoutParams()).topMargin = topMargin;
    ...
    public void onBackPressed() {
        ...
        if (mMediaObject != null && mMediaObject.getDuration() > 1) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(com.mabeijianxi.smallvideorecord2.R.string.hint)
                    .setMessage(com.mabeijianxi.smallvideorecord2.R.string.record_camera_exit_dialog_message)
                    .setNegativeButton(
                            com.mabeijianxi.smallvideorecord2.R.string.record_camera_cancel_dialog_yes,
                    ...
                    .setPositiveButton(com.mabeijianxi.smallvideorecord2.R.string.record_camera_cancel_dialog_no,
...
//        mRecordDelete.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        // 处理开启回删后其他点击操作
        if (id != com.mabeijianxi.smallvideorecord2.R.id.record_delete) {
            if (mMediaObject != null) {
...
//                        mRecordDelete.setChecked(false);
        ...
        if (id == com.mabeijianxi.smallvideorecord2.R.id.title_back) {
            onBackPressed();
        } else if (id == com.mabeijianxi.smallvideorecord2.R.id.record_camera_switcher) {// 前后摄像头切换
        ...
        } else if (id == com.mabeijianxi.smallvideorecord2.R.id.record_camera_led) {// 闪光灯
            // 开启前置摄像头以后不支持开启闪光灯
            if (mMediaRecorder != null) {
                if (mMediaRecorder.isFrontCamera()) {
                    return;
        ...
        } else if (id == com.mabeijianxi.smallvideorecord2.R.id.title_next) {// 停止录制
            stopRecord();
            /*finish();
            overridePendingTransition(R.anim.push_bottom_in,
					R.anim.push_bottom_out);*/
        } else if (id == com.mabeijianxi.smallvideorecord2.R.id.record_delete) {
            // 取消回删
            if (mMediaObject != null) {
                MediaObject.MediaPart part = mMediaObject.getCurrentPart();
                if (part != null) {
...
//                    mRecordDelete.setVisibility(View.GONE);
    ...
    public void onEncodeStart() {
        showProgress("", getString(com.mabeijianxi.smallvideorecord2.R.string.record_camera_progress_message));
    }
...
//            startActivity(intent);
    ...
    public void onEncodeError() {
        hideProgress();
        Toast.makeText(this, com.mabeijianxi.smallvideorecord2.R.string.record_video_transcoding_faild,
