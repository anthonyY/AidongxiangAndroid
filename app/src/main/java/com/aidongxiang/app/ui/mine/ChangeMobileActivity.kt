...
//                        switchToActivityForResult(ChangeMobileNextActivity::class.java, 1, ARG_SMSCODE_ID to smscodeId)
//                    } else if(index == 2){
//                        switchToActivityForResult(ChangeMobileNextActivity::class.java, 1, Constants.ARG_MOBILE to mobile, ARG_SMSCODE_ID to smscodeId)
//                    } else {
//
//                    }
//                }
