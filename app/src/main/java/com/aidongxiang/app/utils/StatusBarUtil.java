...
public class StatusBarUtil {
     ...
     */
    public static void addStatusBarView(View view, @ColorRes int colorRes) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
    ...
    public static void setWhiteStatusBar(Activity activity) {
        ...
        addCustomStatusBar(activity, android.R.color.white);
    }

    /**
     * 设置状态栏颜色，其实是添加View 占据状态栏的位置，并且设置成默认颜色
     * @param activity 活动类
     */
    public static void addCustomStatusBar(Activity activity) {
        addCustomStatusBar(activity, R.color.colorPrimary);
    }
    /**
