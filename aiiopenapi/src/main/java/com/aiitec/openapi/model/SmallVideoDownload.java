...
public class SmallVideoDownload extends Entity implements Parcelable {
...
//    }
    ...
    public SmallVideoDownload() {
    }

    protected SmallVideoDownload(Parcel in) {
        this.id = in.readLong();
    ...
    public static final Creator<SmallVideoDownload> CREATOR = new Creator<SmallVideoDownload>() {
        @Override
        public SmallVideoDownload createFromParcel(Parcel source) {
            return new SmallVideoDownload(source);
        }

        @Override
        public SmallVideoDownload[] newArray(int size) {
            return new SmallVideoDownload[size];
        }
    };
}
